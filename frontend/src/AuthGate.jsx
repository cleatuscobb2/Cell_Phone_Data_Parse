  ...
  return (
    <Centered>
      <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        <h1 className="text-xl font-bold text-slate-800">Custodia</h1>
        <p className="mt-2 text-sm text-slate-500">
          Sign in to build the record of your child&rsquo;s care,
          responsibilities, and expenses from your own messages, receipts, and
          statements. Your files go only to your own backend and are deleted
