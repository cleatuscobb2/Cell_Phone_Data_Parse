...
**Backend** — Python 3.11+ · FastAPI + uvicorn (local) · Firebase Cloud Functions Python (production) · Pydantic v2 · Anthropic SDK (`claude-opus-4-7`, structured output via a non-strict `submit` tool, prompt caching)
